...
public class CompanyList 
    extends EntitiesList<CompanyListModel, CompanyListController> {
    
    @Override
    protected FXMLCombiner getCombiner() {
        FXMLCombiner combiner = super.getCombiner();
        combiner.addAttributeVariable("CONTROLLER", CompanyListController.class.getName());
        combiner.addFXMLVariable("ENTITIES_TABLE_VIEW", this.getClass().getResourceAsStream("CompanyListTableView.fxml"));
        return combiner;
    }
}
