...
public class EmployeeList
    extends EntitiesList<EmployeeListModel, EmployeeListController> {
    
    @Override
    protected FXMLCombiner getCombiner() {
        FXMLCombiner combiner = super.getCombiner();
        combiner.addAttributeVariable("CONTROLLER", EmployeeListController.class.getName());
        combiner.addFXMLVariable("ENTITIES_TABLE_VIEW", this.getClass().getResourceAsStream("EmployeeListTableView.fxml"));
        return combiner;
    }
}
